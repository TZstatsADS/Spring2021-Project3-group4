...
Shu, Chunyun: constructed K-Nearest Neighbor model, tuning the hyperparameter, cross validation and recorded scores from evaluation, both in R and Python models. Contributed to the presentation slides.
