...
```{r wkdir, eval=FALSE}
set.seed(2020)
setwd("D:/CU--STAT--MA/GR 5243 Applied Data Science/project 3/Spring2021-Project3-group-4-master/doc")
...
run.cv.knn<-TRUE #run cross-validation on the training set applying GBM mod
run.train.knn<-TRUE 
run.test.knn<-TRUE
